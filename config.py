...
LocationSample = (WidgetInfo('STATE', 'State', 20, True, 200),
                  WidgetInfo(name='CITY', label='City', width=20, show_column=True, column_width=20),
                  WidgetInfo('ZIP', 'Zip', 20, True, 200),
                  WidgetInfo('DESCRIPTION', 'Description', 20))
